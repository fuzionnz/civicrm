...
class CRM_Admin_Form_LabelFormats extends CRM_Admin_Form
{
    ...
    public function buildQuickForm( ) 
    {
        ...
        $disabled = array();
        $required = true;
        $is_reserved = $this->_id ?
                       CRM_Core_BAO_LabelFormat::getFieldValue( 'CRM_Core_BAO_LabelFormat', $this->_id, 'is_reserved' ) : false;
        if ( $is_reserved ) {
        ...
        $this->add( 'select', 'paper_size', ts( 'Sheet Size' ), 
                     ...
                     array('onChange' => "selectPaper( this.value );") + $disabled );
        ...
        $this->add( 'select', 'orientation', ts('Orientation'), CRM_Core_BAO_LabelFormat::getPageOrientations(), false,
                     array('onChange' => "updatePaperDimensions();") + $disabled );
    ...
    public function postProcess() 
    {
        ...
        $style = '';
        if ( isset( $values['bold'] ) )   $style .= 'B';
        if ( isset( $values['italic'] ) ) $style .= 'I';
