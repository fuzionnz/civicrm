...
class CRM_Core_Payment_PayflowPro extends CRM_Core_Payment {
    ...
    function doDirectPayment( &$params ) {
        ...
        if ( $params['is_recur'] == true ) {
            ...
            // $payflow_query_array['MAXFAILPAYMENTS']   = 0;//The
        ...
        $submiturl    = $this->_paymentProcessor['url_site'];//ie. url at payment processor to submit to.
    ...
    function submit_transaction ( $submiturl, $payflow_query ) {   
        ...
        // below in the cURL section, the t
        //imeout
        ...
        $headers[] = "X-VPS-VIT-Integration-Product: CiviCRM";  // optional header field
        ...
        while ( $i++ <= 3 ) {
            ...
            } else if ( $responseHeaders['http_code'] == 200 ) {
    ...
    function getRecurringTransactionStatus( $recurringProfileID, $processorID ) {
        ...
        $payflow_query_array = array(      
                                     ...
                                     'PWD'        => $this->_paymentProcessor['password'],
                                     'TENDER'     => 'C',  // C - Direct Payment using credit card
                                     'TRXTYPE'    => 'R',  // A - Authorization, S - Sale
                                     'ACTION'     => 'I',
                                     //A for add recurring
