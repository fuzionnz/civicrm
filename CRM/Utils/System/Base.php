...
class CRM_Utils_System_Base {
    ...
    function theme( $type, &$content, $args = null, $print = false, $ret = false, $maintenance = false ) {
        // TODO: Split up; this was copied verbatim from CiviCRM 4.0's multi-UF theming function, but the parts should be copied into cleaner subclass implementations
